...
- **Dark Themes**: Optimized for coding in low-light environments.
...
* **JS/TS String Syntax**: Improve your JavaScript and TypeScript coding experience with [JS/TS String Syntax](https://marketplace.visualstudio.com/items?itemName=ericgomez.js-string-syntax), which highlights HTML/XML, SQL, CSS, and embedded selectors inside JavaScript and TypeScript strings (including template literals).
  Provides dedicated highlighting for selectors like `#id`, `.class`, and `[attribute]` when used in `querySelector()`, `querySelectorAll()`, and jQuery calls.
